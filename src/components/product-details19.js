...
import ShopDetails19 from './shop-components/shop-details19';
import ShopDetails20 from './shop-components/shop-details20';

const Product_Details19 = () => {
    return <div>
        <NavbarV2 />
        <PageHeader headertitle="Terra
...
export default Product_Details19
