...
import ShopDetails24 from './shop-components/shop-details24';

const Product_Details24 = () => {
    return <div>
        <NavbarV2 />
        <PageHeader headertitle="Hospital - Dialysis Center
...
export default Product_Details24