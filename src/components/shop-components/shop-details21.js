...
class ShopDetails21 extends Component {
    ...
    return <div className="ltn__shop-details-area pb-10">
				...
				<div className="row">
					...
					<div className="ltn__shop-details-inner ltn__page-details-inner mb-60">
						...
						<h2 id='responsive-text-project-heading'>  Airbnb/ Raw
                        </h2>
                     ...
                     <p  id='responsive-text-project-title'>The design draws inspiration from the Japanese concept of Wabi Sabi where beauty lies in imperfection. A minimalist warm ‘raw’  approach has been taken while designing, where the true nature if the material is allowed to shine. The design required it to be cost effective and trendy that would sell itself and attract more customers to the stay. Keeping this in mind, we tried to to create pretty nooks.
                        </p>
...
<div className="row">
	...
	<a>
								<img className="mb-30" src={publicUrl+"assets/img/Allimgs/Picture81.webp"} alt="Image" />
							</a>
	...
	<a>
								<img className="mb-30" src={publicUrl+"assets/img/Allimgs/Picture82.webp"} alt="Image" />
							</a>
    </div>
   
</div>
</div>
<h4 className="title-2"  id='responsive-text-project-heading'>Wabi Sabi /Beauty in Raw

</h4>

<p  id='responsive-text-project-title'>Japanese Shoji Screen inspired pine wood divider seperates the living from Dining, while it also builds suspense before one transitions from dining to Living. We’ve Tried to repurpose materials, staying true to the concept.
...
<div className="row">
    <div className="col-md-6">
	{/* <a href={publicUrl+"assets/img/Allimgs/Picture83.webp"} data-rel="lightcase:myCollection"> */}
								<img className="mb-30" src={publicUrl+"assets/img/Allimgs/Picture83.webp"} alt="Image" />
							{/* </a> */}

    </div>
    <div className="col-md-6">
	{/* <a href={publicUrl+"assets/img/Allimgs/Picture84.webp"} data-rel="lightcase:myCollection"> */}
								<img className="mb-30" src={publicUrl+"assets/img/Allimgs/Picture84.webp"} alt="Image" />
							{/* </a> */}
...
<p className="col-lg-10 col-md-12"  id='responsive-text-project-title'>Japanese Shoji Screen inspired pine wood divider seperates the living from Dining, while it also builds suspense before one transitions from dining to Living. We’ve Tried to repurpose materials, staying true to the concept.
