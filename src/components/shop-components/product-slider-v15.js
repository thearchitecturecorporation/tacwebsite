...
class ProductSliderV15 extends Component {
    ...
    return <div className="ltn__img-slider-area mb-90">
				...
				<div className="row ltn__image-slider-5-active slick-arrow-1 slick-arrow-1-inner ltn__no-gutter-all">
					...
					<div className="ltn__img-slide-item-4">
						...
						<img src={publicUrl+"assets/img/Allimgs/20.png"} alt="Image" />
						</a>
					</div>
					</div>
					<div className="col-lg-12">
					<div className="ltn__img-slide-item-4">
						...
						<img src={publicUrl+"assets/img/Allimgs/21.png"} alt="Image" />
						</a>
					</div>
					</div>
					<div className="col-lg-12">
...
export default ProductSliderV15